...
- `3a20092 feat: implement ask command with multi-provider LLM support and context retrieval functionality`
- `e5beb6d feat: initialize core scanner, CLI framework, and project documentation automation for ContextForge`
- `79cfa79 chore: ignore .agent directory in git tracking`
